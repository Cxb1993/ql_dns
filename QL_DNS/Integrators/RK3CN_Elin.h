...
#ifndef __QL_DNS__RK3CN_Elin__
#define __QL_DNS__RK3CN_Elin__

#include "Integrator.h"
#include "../solution.h"

class RK3CN_Elin : public Integrator {
public:
    RK3CN_Elin(double t0, Inputs& SP, Model * mod);
    ~RK3CN_Elin();
    // Step
...
private:
    ...
    doubVec exponL; // Used for both mean and fluctuations
...
#endif /* defined(__QL_DNS__RK3CN_Elin__) */
