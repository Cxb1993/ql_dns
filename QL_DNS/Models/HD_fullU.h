...
#ifndef __QL_DNS__HD_fullU__
#define __QL_DNS__HD_fullU__
...
private:
    ...
    dcmplxVec *u_; // (uy,uz,dx{ux,uy,uz},dy{ux,uy,uz}) (and b)
...
#endif /* defined(__QL_DNS__HD_fullU__) */
