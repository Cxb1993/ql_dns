...
#ifndef CompMHDIso_FixedMF_h
#define CompMHDIso_FixedMF_h
...
class CompMHDIso_FixedMF : public Model {
public:
    CompMHDIso_FixedMF(const Inputs& sp, MPIdata& mpi, fftwPlans& fft);
    ~CompMHDIso_FixedMF();
...
private:
    ...
    double kappa_, nu_, eta_; // dissipation
    const int viscosity_order_; // Order of Laplacian for dissipation
    ...
    int num_noise_vars_;// Number of noise bits that need to be passed around
